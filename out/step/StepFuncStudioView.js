 ...
 */
class StepFuncStudioEditorProvider {
    static viewType = 'stepFuncStudio.asl';
    static webviewHtml;
    ...
    static register(context) {
        ...
        return vscode.window.registerCustomEditorProvider(StepFuncStudioEditorProvider.viewType, provider, {
            webviewOptions: {
    ...
    static async openWithWorkflowStudio(uri, params) {
        await vscode.commands.executeCommand('vscode.openWith', uri, StepFuncStudioEditorProvider.viewType, params);
    }
    /**
    ...
    async resolveCustomTextEditor(document, webviewPanel, _token) {
        ...
        try {
            ...
            const visualization = new StepFuncStudioView(document, webviewPanel, fileId, stateMachineName, aslDefinition, workflowMode);
...
exports.StepFuncStudioEditorProvider = StepFuncStudioEditorProvider;
/**
